...
<div class="col-xl-12 mb-30">
    <div class="card card-statistics h-100">
        <div class="card-body">
            <a href="{{route('Subjects.create')}}" class="btn btn-outline-success btn-sm" role="button" style="padding:5px; margin: 5px;" 
                            ...
                            <div class="modal-dialog" role="document">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">هل انت متأكد من حذف هذه المادة؟ </h5>
